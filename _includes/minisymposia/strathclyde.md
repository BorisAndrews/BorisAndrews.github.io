- **JUN.2025** <code>&#124;</code> {% include conferences/2025/strathclyde.md %}, *{% include universities/strathclyde.md %}*
  ...
  - **SPEAKERS** <code>&#124;</code> {% include collaborators/aaron_brunk/short.md %}, {% include collaborators/mingdong/short.md %}, {% include collaborators/kaibo/short.md %}, {% include collaborators/rami/short.md %}