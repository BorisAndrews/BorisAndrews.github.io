...
- **2025** <code>&#124;</code> {% include conferences/2025/ems_school.md %}\* *(Kácov, Czechia)*, Invited talk\* *({% include universities/brown.md %})*, {% include conferences/2025/cse.md %}\* *(Fort Worth, Texas)*, {% include conferences/2025/firedrake_usa.md %}\* *({% include universities/baylor.md %})*, Numerical Mathematics & Scientific Computing seminar\* *({% include universities/rice.md %})*
