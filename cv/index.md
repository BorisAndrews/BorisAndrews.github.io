...
- **2026** <code>&#124;</code> {% include conferences/2026/firedrake.md %}* *({% include universities/oxford.md %})* / {% include conferences/2026/tensor.md %} *({% include universities/tsinghua.md %})*
