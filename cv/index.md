...
- **2025** <code>&#124;</code> {% include conferences/2025/ems_school.md %}\* *(Kácov, Czechia)*, Invited talk\* *({% include universities/brown.md %})*, {% include conferences/2025/firedrake_usa.md %}\* *(Fort Worth, Texas)*, Numerical Mathematics & Scientific Computing seminar\* *({% include universities/rice.md %})*
