...
- **2025** <code>&#124;</code> {% include conferences/2025/acomen.md %}\* *({% include universities/ghent.md %})*, {% include conferences/2025/strathclyde.md %}\* *({% include universities/strathclyde.md %})*, {% include conferences/2025/ems_school.md %}\* *(Kácov, Czechia)*, Numerical Mathematics & Scientific Computing seminar\* *({% include universities/rice.md %})*, {% include conferences/2025/cse.md %}\* *(Fort Worth, Texas)*, {% include conferences/2025/firedrake_usa.md %}\* *({% include universities/baylor.md %})*, Scientific Computing Seminar\* *({% include universities/brown.md %})*
