...
We can apply the framework from [mine and Patrick Farrell's preprint](../sp-integrators/index.md) to preserve both the **conservative** and **non-dissipation** structures.
