...
### SEP.2025 ([arXiv](https://doi.org/10.48550/arXiv.2407.11904)) <code>&#124;</code> DEC.2025 ([SISC](https://doi.org/10.1137/25M1756673))
...
Conserving simple, quadratic quantities (e.g. the energy in Navier–Stokes) is pretty well-understood, in particular in finite element discretisations.
...
In a [recently published paper](/publications/sp-integrators-b/), {% include collaborators/patrick/short.md %} and I apply these ideas to two very general classes of problems:
...
We're similarly able to construct a general integrator that preserves both energy conservation and entropy generation.
Notably, this includes the Boltzmann equation!
