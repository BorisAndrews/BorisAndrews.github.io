...
<div class="reveal-box" onclick="var details = this.querySelector('.details'); details.style.display = (details.style.display === 'block') ? 'none' : 'block';">
    ...
    <div class="details">
        ...
        Yet, this belief is *not entirely accurate*... <br><br>
        
        Symplecticity enhances the *collective* behaviour of a group of simulations. This is great!
        ...
        However, this **does not guarantee energy conservation**. <br><br>
