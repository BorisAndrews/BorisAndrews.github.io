...
<!-- ### 2025 -->
- **21–22.MAY** <code>&#124;</code> **EDINBURGH VISIT** <code>&#124;</code> Visiting {% include collaborators/kaibo/short.md %} at the *{% include universities/edinburgh.md %}*, where I will present [our work on structure-preserving integrators for the Parker problem](/publications/parker/) with {% include collaborators/mingdong/short.md %} & {% include collaborators/patrick/short.md %} at the {% include visits/2025/edinburgh.md %} (21.MAY) jointly hosted with *{% include universities/heriot-watt.md %}*
